...
```
>[!Warning]
> - Обязательно убедитесь, что все репозитории отключены, чтобы установка пакетов происходила исключительно из offline архива. <br>Для этого удалите или закомментируйте (добавив символ # в начало строки) все строки в файле /etc/apt/sources.list, а также очистите содержимое папки /etc/apt/sources.list.d.
