...
4. Установка Корпоративного сервера<br> 
    4.1 Установка Корпоративного сервера на сервере 1<br>
    4.2 Установка Корпоративного сервера на сервере 2<br>
    4.3 Установка спам-фильтра Spamassassin(опционально)<br>
    4.4 Проверить квоты на почтовом ящике и получить JWT-токен<br>
...
>[!Warning]
> - Инструкция ниже выполняется **$${\color{red}НА}$$ $${\color{red}ВТОРОМ}$$ $${\color{red}СЕРВЕРЕ №2}$$**
